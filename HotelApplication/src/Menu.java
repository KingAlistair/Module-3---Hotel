...
public class Menu {
    ...
    public void createBooking() {
        ...
        while (loop) {
            ...
            for (Room roomArr : availableRooms
            ) {
            ...
            while (loop2) {
                ...
                if (end.isBefore(start)) {
                    loop2 = true;
                    System.out.println("Your can't check out before you check in, you silly goose! Try again!\n");
                } else {
                    loop2 = false;
                }
    ...
    public void manageBooking() {
        ...
        int inputID = intInput();
        Booking booking = null;

        for (Booking booking1 : bookingList
        ) {
            if (inputID == booking1.getId()) {
                booking = booking1;
